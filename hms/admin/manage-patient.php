                            ...
                            <div class="col-md-12">
                                ...
                                <form method="GET" action="" class="">
                                    <div class="form-group">
                                        <input type="text" id="searchInput" name="search" class="form-control search-input" placeholder="Search by Name, Contact, or Gender" value="<?php echo htmlentities($search); ?>" />
                                    </div>
