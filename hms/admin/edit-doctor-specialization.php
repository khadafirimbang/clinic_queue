...
if (isset($_POST['submit'])) {
    ...
    $sql = mysqli_query($con, "UPDATE doctorSpecilization SET specilization='$docspecialization', room='$room' WHERE id='$id'");
...
<?php include('include/sidebar.php');?>
    ...
    <div class="form-group">
        ...
        $row = mysqli_fetch_array($sql); // Fetch the row once
        ?>
        <input type="text" name="doctorspecilization" class="form-control" required value="<?php echo $row['specilization']; ?>" >
    </div>
    <div class="form-group">
        <label for="room">Edit Room Number</label>
        <input type="number" name="room" class="form-control" required value="<?php echo $row['room']; ?>" > <!-- Use the fetched room value -->
    </div>
