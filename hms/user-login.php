	...
	<body class="login">
		<div class="row">
			<div class="main-login col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
				...
				<a href="../index.php"><h2> <strong><center>Patient Login</center></strong></h2></a>
				</div>
			  <div class="box-login">
					<form class="form-login" method="post">
	
						<legend style="color: #6C6C6C;">
								<center>Enter your credentials.</center>
					  </legend>
							<p>
					  ...
					  <div class="form-actions">
					    ...
					    <span class="new-account">Don't have an account yet? <a href="registration.php"> Create an account </a></span></div>
